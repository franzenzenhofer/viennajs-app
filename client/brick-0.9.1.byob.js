/* http://mozilla.github.io/brick/download.html?byob=x-tag-appbar,x-tag-calendar,x-tag-deck,x-tag-flipbox,x-tag-layout,x-tag-slidebox,x-tag-slider,x-tag-tabbar,x-tag-toggle,x-tag-tooltip */ // We don't use the platform bootstrapper, so fake this stuff.
